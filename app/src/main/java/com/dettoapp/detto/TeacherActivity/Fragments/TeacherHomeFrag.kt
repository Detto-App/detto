...
class TeacherHomeFrag : Fragment(), GroupInfoDialog.GroupInfoDialogOnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val factory =
            TeacherHomeFragFactory(TeacherRepository(), requireContext().applicationContext)
        viewModel =
            ViewModelProvider(requireActivity(), factory).get(TeacherHomeFragViewModel::class.java)
    }
